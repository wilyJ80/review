...
\textbf{4. Validação e Coleta de Dados:} O foco primário da validação observará dois aspectos práticos:
\begin{itemize}
    ...
    \item \textit{Validação da Experiência de Usuário e Pedagógica:} Avaliação qualitativa focada na facilidade de montagem do experimento e na interação do usuário final (alunos e professores) com o sistema desenvolvido.
\end{itemize}
