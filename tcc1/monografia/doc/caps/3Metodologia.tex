...
O código a ser gravado na memória \textit{flash} da placa ESP32, escrito em Arduino Framework, irá orquestrar a escolha dos pinos a serem utilizados da placa, os comandos de leituras e o intervalo entre as leituras, além de realizar as solicitações HTTP para o envio das coletas para o servidor Raspberry Pi. Um código identificador será disposto em um \textit{display} na montagem, o que permitirá que o usuário identifique as leituras realizadas posteriormente na aplicação \textit{web}.
