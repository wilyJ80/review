...
Na camada de servidor, foi escolhido o \textit{framework} web Quart, do ecossistema Python, para toda a camada web a ser desenvolvida e implantada no servidor Raspberry Pi.
...
\textit{[Espaço para descrever detalhadamente o percurso experimental, desde a preparação do ambiente até a coleta e validação dos dados, demonstrando o rigor científico na condução do experimento.]}
